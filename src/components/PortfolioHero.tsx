  ...
  return (
    <div ref={scrollSectionRef} className="relative w-full bg-brutal-bg">
      ...
      >
        ...
        <section className="hero-content relative z-20 flex min-h-0 flex-1 flex-col text-brutal-fg">
          <div
            ref={heroBackdropRef}
          ...
          >
            ...
            <footer
              ref={footerRef}
              className="flex shrink-0 items-center justify-between border-t border-brutal-border px-5 py-4 font-mono text-[10px] uppercase tracking-widest text-brutal-fg/55 will-change-transform sm:px-8 sm:py-5 lg:px-10"
            >
